...
$kodeLengkap = $unit['kode_barang'] . '/' . $unit['jumlah_total'] . '/' . $unit['urutan_unit'];
?>
...
<div class="content">
    <div class="container-fluid p-4">
        ...
        <div class="form-card">
            <a href="<?= BASEURL; ?>DetailBarang/detail/<?= IdObfuscator::encode($unit['id_spesifikasi']); ?>" class="btn-close-absolute">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-input" value="<?= $unit['sub_barang']; ?> - <?= $unit['nama_merek_barang']; ?>" disabled 
                            ...
                            <select name="id_status" class="form-select" required>
                                ...
                                <?php foreach ($data['status'] as $opt) : ?>
                                    <option value="<?= $opt['id_status'] ?>"
                                        <?= ($unit['id_status'] == $opt['id_status']) ? 'selected' : '' ?>>
                                        <?= $opt['status'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="keterangan_label" class="form-select">
                                <option value="Sudah" <?= ($unit['keterangan_label'] == 'Sudah') ? 'selected' : '' ?>>Sudah Dilabel</option>
                                <option value="Belum" <?= ($unit['keterangan_label'] == 'Belum') ? 'selected' : '' ?>>Belum Dilabel</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="status_peminjaman" class="form-select">
                                <option value="Bisa" <?= ($unit['status_peminjaman'] == 'Bisa') ? 'selected' : '' ?>>Bisa Dipinjam</option>
...
<style>
    ...
    .btn-close-absolute:hover { color: #dc3545; transform: rotate(90deg); }
    .form-title {
        font-size: 24px;
        font-weight: 700;
        color: #333;
    ...
    .btn-submit:hover { transform: translateY(-2px); box-shadow: 0 6px 15px rgba(18, 80, 186, 0.4); }
</style>