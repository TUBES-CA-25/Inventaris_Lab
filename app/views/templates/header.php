...
<head>
    ...
    <link rel="stylesheet" href="<?= BASEURL; ?>css/asisten_dashboard.css?v=<?= APP_VERSION; ?>">
    <link rel="stylesheet" href="<?= BASEURL; ?>css/laboran_dashboard.css?v=<?= APP_VERSION; ?>">
    <link rel="stylesheet" href="<?= BASEURL; ?>css/mahasiswa_dashboard.css?v=<?= APP_VERSION; ?>">
